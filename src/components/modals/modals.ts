...
export const changeModals = <D extends NModals.TModals>(
  eventDetail: D,
): CustomEvent<D> => new CustomEvent("changeModals", { detail: eventDetail });
...
export namespace NModals {
  ...
  export type TModals = Partial<
    Record<
      ...
      ComponentProps<(typeof modals)[number]["Modal"]>
    >
  >;
}
